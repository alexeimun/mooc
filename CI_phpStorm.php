    ...
    *
    *@property auth_assignment_model $auth_assignment_model
*@property auth_item_model $auth_item_model
*@property auth_type_model $auth_type_model
*@property course_teachers_model $course_teachers_model
*@property courses_model $courses_model
*@property enrolled_model $enrolled_model
*@property lections_model $lections_model
