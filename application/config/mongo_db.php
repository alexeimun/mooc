...
$config['mongo_db']['default']['hostname'] = 'ds025742.mlab.com';
$config['mongo_db']['default']['port'] = '25742';
$config['mongo_db']['default']['username'] = 'alexeimun';
$config['mongo_db']['default']['password'] = 'holbach191';
$config['mongo_db']['default']['database'] = 'taste';
